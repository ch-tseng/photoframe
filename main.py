...
getFaceAfter = 3  #剛剛抓到的FACE可能晃動或使用者還未準備好，因此改為使用連續抓取後的第幾張FACE
...
#    face_cascade = cv2.CascadeClassifier('/usr/local/share/OpenCV/haarcascades/haarcascade_frontalface_alt_tree.xml')
    ...
    if(len(faces)>0):
        ...
        for (x,y,w,h) in faces:
            ...
            if (faceGetAccumulated>=getFaceAfter and ynWatson==1 and xFace<460 and xFace>180 and yFace<360 and yFace>160):  #Use Watson to analysis if the first face is at center (160<x<170)
